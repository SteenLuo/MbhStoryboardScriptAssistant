function buildCompletenessMatrix() {
  return [
    ...
    },
    {
      milestone: "M4",
      name: "评测和进化",
      expected: "技能改进有评测证据，能统计分镜指标并生成 skill-creator 待执行任务。",
      ...
      gaps: ["网页没有评测任务和 skill-creator 任务的完整浏览入口。"],
      next: "增加评测任务、学习快照和 skill-creator 任务的只读入口。",
    },
    {
      milestone: "M5",
      name: "自主学习闭环",
      expected: "对话、反馈、样例和降质记录能转成学习记录、学习资料和 skill-creator 待执行任务。",
