function buildCompletenessMatrix() {
  return [
    ...
    },
    {
      milestone: "M4",
      name: "评测和进化",
      expected: "技能改进有评测证据，能统计分镜指标，并能通过 skill-creator 把主动技能学习修改到正式 skill。",
      webStatus: "部分接入：后台脚本完整，网页可通过学习闭环刷新进入 M4/M5 汇总。",
      evidence: ["tools/Measure-Storyboard.ps1", "tools/New-SkillCreatorTask.ps1", "learning/evals/"],
      gaps: ["网页没有评测任务和历史技能任务的完整浏览入口。"],
      next: "增加评测任务、学习快照和历史技能任务的只读入口。",
    },
    {
      milestone: "M5",
      name: "自主学习闭环",
      expected: "对话、反馈、样例和降质记录能转成学习记录；主动技能学习能调用 skill-creator 修改正式 skill。",
